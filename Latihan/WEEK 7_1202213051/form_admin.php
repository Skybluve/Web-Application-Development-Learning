            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                            ...
                            <a href='form_admin.php?action=deleted&id=" . $row['id'] . "' class='btn btn-danger btn-action' onclick=\"return confirm('Apakah Anda yakin ingin menghapus item ini?')\">Delete</a>
                          </td>";
                    echo "</tr>";
